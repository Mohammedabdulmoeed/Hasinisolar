        ...
        <div className="container-custom px-4 relative z-10 max-w-7xl mx-auto">
          <div className="grid grid-cols-12 gap-6 lg:gap-12 items-center">
            ...
            <div className="col-span-12 lg:col-span-7 flex flex-col justify-center">
              ...
              Sun Volt Solar   integrates structural tier-1 hardware frameworks with intelligent telemetry arrays. We transition local corporate architectures into highly independent, clean power infrastructures optimized for sustained financial return.
              </p>
            ...
            <div className="col-span-12 lg:col-span-5 relative h-[200px] sm:h-[340px] rounded-2xl overflow-hidden border border-slate-100 shadow-xl group">
              <img 
                ...
                alt="Sun Volt Solar Station Profile" 
