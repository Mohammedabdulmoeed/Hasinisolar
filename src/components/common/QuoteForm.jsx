...
export default function QuoteForm({ onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validate()) {
      ...
      console.log('=== SUNVOLT SOLAR - QUOTE SUBMISSION DATA ===');
      ...
      try {
        const response = await fetch("https://formsubmit.co/ajax/Sunvoltsolar26@gmail.com", {
          method: "POST",
          headers: {
          ...
          body: JSON.stringify({
            ...
            _captcha: "false",
            _template: "table",
            _autoresponse: "Thank you for contacting Sun Volt Solar. Our solar expert will contact you shortly."
          })
        });
