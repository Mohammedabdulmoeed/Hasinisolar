...
<div className="flex gap-4">
  ...
  <div>
    ...
    <p className="text-slate-600">
     ...
     {/* Right Subsidy Info */}
<div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-[32px] p-10 text-white relative overflow-hidden">

  <div className="absolute top-0 right-0 w-56 h-56 bg-emerald-500/20 blur-3xl" />
  <div className="absolute bottom-0 left-0 w-40 h-40 bg-cyan-500/10 blur-3xl" />
