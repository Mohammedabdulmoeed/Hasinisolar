  ...
  return (
    <section id="services" className="section-padding bg-slate-50 relative overflow-hidden">
      ...
      <div className="container-custom relative">
        <SectionHeading
  label="Our Solar Solutions"
  title="Smart Solar Energy Solutions for Every Need"
  subtitle="From residential rooftop systems to large-scale industrial solar installations, we provide end-to-end solar solutions with premium technology and expert support."
/>
