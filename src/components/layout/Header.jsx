...
//   // Header background: Solid white when scrolled/inner page (Image 2), Slate/Dark transparent when at top of home (Image 1)
//   const headerBgClass = isLightHeader
//     ? 'bg-white/95 backdrop-blur-xl shadow-md border-b border-slate-200/80 py-2.5'
//     : 'bg-slate-900/90 backdrop-blur-xl border-b border-white/10 py-3.5';
...
//             aria-label="Hasini Solar Enterprises & Solutions Home"
//           >
//             <img
//               src={isLightHeader ? logos : logob}
//               alt="Hasini Solar Enterprises & Solutions Logo"
...
//                         : `${linkTextClass} hover:bg-black/5`
//                     }`
//                   }
//                 >
//                   {link.label}
...
//                 aria-label="Call Hasini Solar Enterprises & Solutions"
//               >
...
const navLinks = [
  ...
  { to: '/projects', label: 'Projects' },
  { to: '/contact', label: 'Contact' },
  { to: '/solar-calculator', label: 'Solar Calcultor' },
];
...
export default function Header({ onQuoteClick }) {
  ...
  // Header background: Solid white when scrolled/inner page, Pitch Black (bg-black/90) when at the top of home page
  const headerBgClass = isLightHeader
    ? 'bg-white/95 backdrop-blur-xl shadow-md border-b border-slate-200/80 py-2.5'
    : 'bg-black/90 backdrop-blur-xl border-b border-white/10 py-3.5';
