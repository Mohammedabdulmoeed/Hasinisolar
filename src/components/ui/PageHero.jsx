...
export default function PageHero({ title, subtitle, image, breadcrumb }) {
  return (
    <section
      // Adjusted mobile heights up to allow content plenty of breathing room underneath stacked headers
      className="relative min-h-[35vh] sm:min-h-[25vh] md:min-h-[25vh] lg:min-h-[50vh] flex items-center overflow-hidden bg-slate-950"
      aria-labelledby="page-hero-title"
    >
      {/* Background Image Layer */}
      <motion.div
      ...
      {/* 
        ...
        Added 'pt-44 pb-8' for mobile viewports. This acts as a protective shield 
        pushing the title directly below the wrapped multi-line header navigation links.
      */}
      <div className="container-custom relative z-10 pt-44 pb-8 sm:py-12 md:py-28 lg:py-32 w-full px-4">
        <motion.div
          variants={staggerContainer}
          initial="hidden"
          animate="visible"
